...
For automatic dependency handling, consider using stacks instead. Please see the example stacks in the [examples/stacks](../../examples/stacks/README.md) directory, or the [Getting started with stacks](../Tutorials/getting_started_with_stacks.md) tutorial.
