...
The stack bootstraps a Juju controller, deploys 3 units of the maas-region charm (region+rack mode), 3 units of the postgresql charm, and 2 units of the s3-integrator charm for backups. MAAS is then configured with example resources.
