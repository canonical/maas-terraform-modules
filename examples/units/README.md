...
1. A bootstrapped Juju controller (skip if using an existing controller). Use the official [Juju Terraform controller catalog](https://github.com/juju/terraform-juju-controller) to bootstrap one.
2. `maas-deploy`
3. `maas-config`
